...
export default function ChiroHD() {
    const points: string[] = [
        `Developed an automated X12 insurance claims parser with SFTP integrations, eliminating manual data entry for 2,500+ chiropractic clinics`,
        `Architected a double-entry accounting system with line-item tracking and balance reconciliation, processing 300,000+ transactions weekly with full audit compliance`,
        `Created CI/CD pipelines and automated deployment workflows, allowing development team to scale a serverless architecture handling millions of monthly API requests`,
        `Designed and implemented a high-throughput Twilio SMS messaging system using a queue-based architecture to absorb traffic spikes during peak clinic hours, reliably handling inbound and outbound messaging`,
        `Built patient-facing Angular applications including clinic check-in kiosks, ERA management screens, and appointment scheduling calendars`,
    ];
    ...
    return (
        ...
        >
            ...
            <p>
                ...
                abstraction, and the whole serverless Lambda model was brand new to me. But Luke was a great mentor. He
                sat me down and walked me through API Gateway and Lambda until it started to click.
            </p>
            ...
            <p>
                ...
                something. More recently, I've shifted toward our ledger system and double entry accounting. (Double
                entry accounting is diabolical.)
            </p>
